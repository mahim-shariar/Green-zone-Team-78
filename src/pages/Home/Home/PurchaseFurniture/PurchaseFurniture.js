...
const PurchaseFurniture = () => {
    ...
    useEffect(() => {
        fetch(`https://stormy-wave-87937.herokuapp.com/purchaseFurniture/${furnitureId}`)
            .then(res => res.json())
        ...
        <Grid item xs={12} md={6}>           
         <form onSubmit={handleSubmit(onSubmit)} style={{display:"flex",flexDirection:'column',width:'40%',margin:'auto'}}>
           <input
             ...
             />
               <input
               style={{width:'150%',padding:'5px',margin:'5px',borderRadius:'5px',fontSize:'20px',color:'white',backgroundColor: '#a71324', border: 'solid 1px #a71324', marginY: 3, textDecoration: 'none' }}
...
export default PurchaseFurniture;